...
export class BudgetService {
    ...
    public updateModelProject: IProject = Object.assign({});
    ...
    getActivity(budgetno: any) {
        return this.httpClient.get<IActivity[]>(this.backendActivity, { params: { budgetno } });
    }
    ...
    /** Project */
    getProject(budgetno: any, activityno: any) {
        return this.httpClient.get<IProject[]>(this.backendProject, { params: { budgetno, activityno } })
    }

    postProject(value: IProject) {
        return this.httpClient.post<IProject[]>(this.backendProject, value)
    }

    putProject(id: any, value: IProject) {
        return this.httpClient.put(this.backendProject, value, { params: { id } })
    }

    deleteProject(id: any) {
        return this.httpClient.delete(this.backendProject, { params: { id } })
    }
